...
const ThankYouPage: NextPage<Props> = async ({ searchParams }) => {
        ...
        <div className="">
            <div className="mx-auto max-w-2xl px-4 py-16 sm:px-6 sm:py-24 lg:grid lg:max-w-7xl lg:grid-cols-2 lg:gap-x-8 lg:px-8 lg:py-32 xl:gap-x-24">
                <div className="lg:col-start-2">
                    <p className='text-sm font-medium text-yellow-600'>Order Successful</p>
                    <h1 className='mt-2 text-4xl font-bold tracking-tight text-gray-900 sm:text-5xl'>
                        Thanks for ordering
                    </h1>
                    {
                        order._isPaid ? <p className='mt-2 text-base text-muted-foreground '>
                            Your order was processed and your assets are available to download below. We&apos;ve sent your receipt and order details to {typeof order?.user !== 'string' ? <span className='font-medium to-gray-900'>
                                {order.user.email}
                            </span> : null}

                        </p> : <p className='mt-2 text-base text-muted-foreground '>
                            We appreciated your order, and we&apos;re currently processing it. So hang tight and we&apos;ll send you confirmation very soon!
                        </p>
                    }
                    ...
                    <div className="mt-16 text-sm font-medium">
                                    ...
                                    <div className="flex-auto flex flex-col justify-between">
                                        ...
                                        {order?._isPaid ? (
                                            <a href={downloadUrl}
                                                ...
                                                className='text-yellow-600 hover:underline underline-offset-2'
                                            >
                                                Download Asset
                                            </a>
                                        ) : null}
                        ...
                        <div className="space-y-6 border-t border-gray-200 pt-6 text-sm font-medium text-muted-foreground">
                            ...
                            <div className='flex justify-between'>
                                <p>Transaction Fee</p>
                                <p className='text-gray-900'>{formatPrice(12.50)}</p>
                            </div>
                        ...
                        <div className="mt-16 border-t border-gray-200 py-6 text-right">
                            <Link className='text-sm font-medium text-yellow-600 hover:text-yellow-500' href={'/products'}>
