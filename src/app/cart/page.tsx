                                ...
                                <li key={product?.id} className='flex py-6 sm:py-10'>
                                    ...
                                    <div className="ml-4 flex flex-1 flex-col justify-between sm:ml-6">
                                        ...
                                        <p className="mt-4 flex space-x-2 text-sm text-gray-700">
                                            ...
                                            />
                                            <span>Eligible for instant devlivery!</span>
                                        </p>
                                    </div>
                                </li>
                            )
                    ...
                    <div className="mt-6 space-y-4">
                        <div className="flex items-center justify-between ">
                            ...
                            <p className='text-sm font-medium text-gray-900'>
                                {isMounted ? formatPrice(cartTotal) : <Loader2
                        ...
                        <div className="flex items-center justify-between border-t border-gray-200 pt-4">
                            ...
                            <div className="text-sm font-medium text-gray-900">
                                {isMounted ? formatPrice(fee) : <Loader2
                                    className='animate-spin h-4 w-4 text-muted-foreground'
                                />}
                            </div>
                        </div>
                        <div className="flex items-center justify-between border-t pt-4 border-gray-200">
                            ...
                            <div className="text-base font-medium text-gray-900 ">
                                <div className="text-sm font-medium text-gray-900">
                                    {isMounted ? formatPrice(cartTotal + fee) : <Loader2
                                        className='animate-spin h-4 w-4 text-muted-foreground'
                                    />}
                                </div>
                            </div>
